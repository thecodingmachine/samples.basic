 ...
 * If you need to perform changes, edit the ProjectTypeBean class instead!
 */

/**
 * The ProjectTypeBaseBean class maps the 'project_type' table in database.
 * @dbTable project_type
 */
class ProjectTypeBaseBean extends TDBMObject 
{
	/**
